...
class ModelWithRecurrentHead(nn.Module):
    ...
    def compute_loss(self, logits, labels, vocab_size, loss_mask=None):
        """
    ...
    def deep_recursion(
        ...
        if labels is not None:
            loss = self.compute_loss(logits, labels, self.base_model.config.vocab_size, loss_mask=loss_mask)
